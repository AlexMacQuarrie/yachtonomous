...
def mpc(vehicle:boat, control_config:settings, T:float, N:int, k:int, x_d:arr, u_d:arr, x_hat:arr) -> arr:
    # Prediction horizon
...
def fsf(vehicle:boat, control_config:settings, x_d:arr, u_d:arr, x_hat:arr) -> arr:
